...
export default function Popupbar({popmessage,setPopmessage}) {
    ...
    return (
        <div className="z-10 w-[80%] max-w-[420px] animate-[popItUp_1s_ease-in_forwards] absolute bottom-3 left-[50%] translate-x-[-50%] flex justify-between items-center gap-4 p-[6px] bg-info rounded-md first-letter">
